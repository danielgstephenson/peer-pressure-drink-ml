...
from load import treatment, covars, obs_count
...
for trial in range(trial_count):
    ...
    for fold in range(fold_count):
        ...
        test_target = treatment[test_obs,:]
        test_covars = covars[test_obs,:]
        train_target = treatment[train_obs,:]
...
targets = treatment.flatten()
outcome_file = open('output/treatment.csv', mode='w', buffering=1)
_ = outcome_file.write('treatment,output\n')
